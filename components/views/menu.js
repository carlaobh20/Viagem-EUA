...
const IT = {
  ...
  logins: { id: 'logins', label: 'Logins', sub: 'Apps, casa, portões e Wi-Fi', cor: '#0E7C68', bg: 'rgba(14,124,104,.13)', icon: <><rect x="3" y="11" width="18" height="10" rx="2" /><path d="M7 11V8a5 5 0 0 1 10 0v3" /><circle cx="12" cy="16" r="1" /></> },
